/**
 * apps/web/app/auth/oauth/gcal/start/route.ts
 *
 * GET handler — initiates the Google Calendar OAuth 2.0 flow (Phase 1.1-C,
 * Scheduler sub-agent).
 *
 * Sequence:
 ...
 *   5. Stash the JWT in an HttpOnly cookie (`oauth_state_gcal`, 10-min TTL,
 ...
 *
 * Cookie path is scoped to /auth/oauth/gcal so it is NEVER attached to any
 * request outside the OAuth dance, including the sibling /auth/oauth/gmail
 * flow.
 *
 * Owner: [Forge + Shield]
 */
